...
ActiveRecord::Schema[7.2].define(version: 2025_06_22_075643) do
  ...
  create_table "rmd_chat_room_users", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["chat_room_id"], name: "index_rmd_chat_room_users_on_chat_room_id"
  ...
  add_foreign_key "rmd_chat_room_users", "chat_rooms"
